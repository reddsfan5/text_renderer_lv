...
def get_char(chars1=CHARS1,chars2=CHARS2):
...
# def get_single_char_txt(single_txt_path,common_txt_path):
#     with open(single_txt_path,mode='w',encoding='utf8') as single_txt,open(common_txt_path,mode='w',encoding='utf8') as common_txt:
#         for single_char in
